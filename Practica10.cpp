...
int main()
{
	...
	Aro_M = Model();
	Aro_M.LoadModel("Models/aro.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// PARED
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(15.0f, 21.0f, -10.5f));
		modelaux = model;
		...
		// ARO
		model = modelaux;
		model = glm::translate(model, glm::vec3(9.0f, 11.0f, 5.0f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//PELOTA
		model = glm::mat4(1.0);
		posPelota = glm::vec3(posXavion + movAvion_x, posYavion + movAvion_y, posZavion);

		// rotación adicional en -Z controlada por R/T
