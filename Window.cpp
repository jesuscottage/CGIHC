...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_Z)
	{
		theWindow->articulacionZ += 10.0;
	}
	if (key == GLFW_KEY_X)
	{
		theWindow->articulacionX += 10.0;
	}
	if (key == GLFW_KEY_C)
	{
		theWindow->articulacionC += 10.0;
	}
	if (key == GLFW_KEY_V)
	{
		theWindow->articulacionV += 10.0;
	}
	if (key == GLFW_KEY_1)
	{
	...
	if (key == GLFW_KEY_5)
	{
		theWindow->articulaciong5 += 10.0;
	}
	if (key == GLFW_KEY_6)
	{
		theWindow->articulaciong6 += 10.0;
	}
	if (key == GLFW_KEY_7)
	{
		theWindow->articulaciong7 += 10.0;
	}
	if (key == GLFW_KEY_8)
	{
		theWindow->articulaciong8 += 10.0;
	}
	if (key == GLFW_KEY_9)
	{
		theWindow->articulaciong9 += 10.0;
	}
	if (key == GLFW_KEY_0)
	{
		theWindow->articulaciong0 += 10.0;
	}
