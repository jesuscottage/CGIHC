...
void CrearDado()
{
        ...
        GLfloat octaedro_vertices[] = {
            // Cara 1: v2, v0, v4
            v2.x, v2.y, v2.z,  0.375f, 0.66f,   0.0f, 0.7071f, 0.7071f,
            v0.x, v0.y, v0.z,  0.49f,  0.34f,   0.0f, 0.7071f, 0.7071f,
            v4.x, v4.y, v4.z,  0.26f,  0.34f,   0.0f, 0.7071f, 0.7071f,

            // Cara 2: v2, v4, v1
            v2.x, v2.y, v2.z,  0.625f,	0.66f,   -0.7071f, 0.7071f, 0.0f,
            v4.x, v4.y, v4.z,  0.74f,	0.34f,   -0.7071f, 0.7071f, 0.0f,
            v1.x, v1.y, v1.z,  0.51f,	0.34f,   -0.7071f, 0.7071f, 0.0f,

            // Cara 3: v2, v1, v5
            v2.x, v2.y, v2.z,  0.875f, 0.66f,   0.0f, 0.7071f, -0.7071f,
            v1.x, v1.y, v1.z,  0.99,   0.34f,   0.0f, 0.7071f, -0.7071f,
            v5.x, v5.y, v5.z,  0.76f,  0.34f,   0.0f, 0.7071f, -0.7071f,

            // Cara 4: v2, v5, v0
            v2.x, v2.y, v2.z,  0.125f, 0.65f,   0.7071f, 0.7071f, 0.0f,
            v5.x, v5.y, v5.z,  0.24f,  0.34f,   0.7071f, 0.7071f, 0.0f,
            v0.x, v0.y, v0.z,  0.01f,  0.34f,   0.7071f, 0.7071f, 0.0f,

            // Cara 5: v3, v4, v0
            v3.x, v3.y, v3.z,  0.625f, 0.32f,   0.0f, -0.7071f, 0.7071f,
            v4.x, v4.y, v4.z,  0.74f,  0.01f,   0.0f, -0.7071f, 0.7071f,
            v0.x, v0.y, v0.z,  0.51f,  0.01f,   0.0f, -0.7071f, 0.7071f,

            // Cara 6: v3, v1, v4
            v3.x, v3.y, v3.z,  0.625f, 0.99f,   -0.7071f, -0.7071f, 0.0f,
            v1.x, v1.y, v1.z,  0.74f,  0.67f,   -0.7071f, -0.7071f, 0.0f,
            v4.x, v4.y, v4.z,  0.51f,  0.67f,   -0.7071f, -0.7071f, 0.0f,

            // Cara 7: v3, v5, v1
            v3.x, v3.y, v3.z,  0.875f, 0.99f,   0.0f, -0.7071f, -0.7071f,
            v5.x, v5.y, v5.z,  0.99,   0.67f,   0.0f, -0.7071f, -0.7071f,
            v1.x, v1.y, v1.z,  0.76f,  0.67f,   0.0f, -0.7071f, -0.7071f,

            // Cara 8: v3, v0, v5
            v3.x, v3.y, v3.z,  0.875f, 0.32f,   0.7071f, -0.7071f, 0.0f,
            v0.x, v0.y, v0.z,  0.99,   0.01f,   0.7071f, -0.7071f, 0.0f,
            v5.x, v5.y, v5.z,  0.76f,  0.01f,   0.7071f, -0.7071f, 0.0f
        };
...
// average normals
	GLfloat cubo_vertices[] = {
		...
		// back
		-0.5f, -0.5f, -0.5f,    0.99,	0.34f,		0.0f,	0.0f,	1.0f,
		0.5f, -0.5f, -0.5f,		0.76f,  0.34f,		0.0f,	0.0f,	1.0f,
		0.5f,  0.5f, -0.5f,		0.76f,	0.64f,		0.0f,	0.0f,	1.0f,
		-0.5f,  0.5f, -0.5f,	0.99f,	0.64f,		0.0f,	0.0f,	1.0f,
...
int main()
{
	...
	Llanta_M = Model();
	Llanta_M.LoadModel("Models/llanta1tex.obj");
