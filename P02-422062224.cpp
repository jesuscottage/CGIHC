...
void CreateShaders()
{
	...
	shaderRojo->CreateFromFiles("shaders/shader.vert", "shaders/shader_rojo.frag");
	shaderList.push_back(*shaderRojo);

	Shader* shaderVerde = new Shader();
	shaderVerde->CreateFromFiles("shaders/shader.vert", "shaders/shader_verde.frag");
	shaderList.push_back(*shaderVerde);

	Shader* shaderAzul = new Shader();
	shaderAzul->CreateFromFiles("shaders/shader.vert", "shaders/shader_azul.frag");
	shaderList.push_back(*shaderAzul);

	Shader* shaderCafe = new Shader();
	shaderCafe->CreateFromFiles("shaders/shader.vert", "shaders/shader_cafe.frag");
	shaderList.push_back(*shaderCafe);

	Shader* shaderVerdeOscuro = new Shader();
	shaderVerdeOscuro->CreateFromFiles("shaders/shader.vert", "shaders/shader_verde_oscuro.frag");
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		GLuint uniformModel = shaderList[2].getModelLocation();
		GLuint uniformProjection = shaderList[2].getProjectLocation();
